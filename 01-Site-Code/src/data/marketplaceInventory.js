...
const marketplaceInventory = [
  {
    id: 2001, name: 'Flared Rinse-Wash Jeans', gender: 'Women', bodyType: ['Curvy', 'Plus', 'Tall'],
  ...
  {
    id: 2002, name: 'High-Waisted Wide-Leg Jeans', gender: 'Women', bodyType: ['Curvy', 'Plus', 'Tall'],
  ...
  {
    id: 2003, name: 'Wide-Leg Mid-Rise Jeans', gender: 'Women', bodyType: ['Curvy', 'Plus', 'Tall'],
  ...
  {
    id: 2010, name: 'Mid-Rise Push-Up Skinny Jeans', gender: 'Women', bodyType: ['Straight', 'Athletic', 'Petite', 'Tall'],
  ...
  {
    id: 2011, name: 'High-Waist Barrel Jeans', gender: 'Women', bodyType: ['Curvy', 'Plus', 'Tall'],
  ...
  {
    id: 2012, name: 'Low-Rise Wide-Leg Jeans', gender: 'Women', bodyType: ['Curvy', 'Plus', 'Tall'],
  ...
  {
    id: 2020, name: 'High Rise Barrel Leg Jeans', gender: 'Women', bodyType: ['Curvy', 'Plus', 'Tall'],
  ...
  {
    id: 2021, name: 'Wide High Waist Jeans', gender: 'Women', bodyType: ['Straight', 'Athletic', 'Petite', 'Tall'],
  ...
  {
    id: 2030, name: "Low Rise '90s Slim Straight Jeans", gender: 'Women', bodyType: ['Straight', 'Athletic', 'Petite', 'Tall'],
  ...
  {
    id: 2031, name: "High Rise '90s Slim Straight Jeans", gender: 'Women', bodyType: ['Straight', 'Athletic', 'Petite', 'Tall'],
  ...
  {
    id: 2032, name: 'Mid Rise Rigid Relaxed Flare Jeans', gender: 'Women', bodyType: ['Curvy', 'Plus', 'Tall'],
  ...
  {
    id: 2040, name: 'TRF High Waist Wide Leg Jeans', gender: 'Women', bodyType: ['Curvy', 'Plus', 'Tall'],
  ...
  {
    id: 2041, name: 'TRF Wide-Leg Low-Rise Jeans', gender: 'Women', bodyType: ['Curvy', 'Plus', 'Tall'],
    priceTier: 'budget', dressCode: ['Casual', 'Business Casual'], category: 'Jeans', color: 'Black', price: 59.9,
    vendor: 'Zara', brand: 'Zara', storeTier: 'Everyday & Designer', availablePantsSizes: numericSizes,
  ...
  {
    id: 2050, name: 'Maeve Colette High-Rise Wide-Leg Full-Length Jeans', gender: 'Women', bodyType: ['Curvy', 'Plus', 'Tall'],
  ...
  {
    id: 2100, name: 'Linen Blend Straight Pants', gender: 'Women', bodyType: ['Straight', 'Athletic', 'Petite', 'Tall'],
  ...
  {
    id: 2101, name: 'Flare Pants', gender: 'Women', bodyType: ['Curvy', 'Plus', 'Tall'],
  ...
  {
    id: 2102, name: 'High-Waisted Straight-Leg Pants', gender: 'Women', bodyType: ['Straight', 'Athletic', 'Petite', 'Tall'],
  ...
  {
    id: 2103, name: 'Camelia Wide-Leg Contrast-Waistband Trousers', gender: 'Women', bodyType: ['Curvy', 'Plus', 'Tall'],
  ...
  {
    id: 2104, name: 'Horsebit Silk Jacquard Pants', gender: 'Women', bodyType: ['Straight', 'Athletic', 'Petite', 'Tall'],
  ...
  {
    id: 2110, name: 'Regular-Fit Cotton-Blend Suit Pants', gender: 'Men', bodyType: ['Slim', 'Athletic', 'Regular'],
  ...
  {
    id: 2111, name: 'Atwell Relaxed-Fit Belted Trousers', gender: 'Men', bodyType: ['Regular', 'Big & Tall', 'Short'],
  ...
  {
    id: 2112, name: 'Re-Nylon Pants', gender: 'Men', bodyType: ['Slim', 'Athletic', 'Regular'],
